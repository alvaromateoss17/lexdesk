  ...
  return (
    <div style={{
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <button style={{ width: 32, height: 32, display: 'grid', placeItems: 'center', borderRadius: 6, color: 'var(--text-2)', cursor: 'pointer', background: 'transparent', border: 0, transition: 'background 0.15s, color 0.15s' }}
