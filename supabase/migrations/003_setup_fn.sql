...
-- Función que crea despacho + perfil en una sola operación segura
...
BEGIN
  ...
  -- Si ya tiene despacho, devolver el existente
  SELECT despacho_id INTO v_despacho_id
  FROM usuarios
